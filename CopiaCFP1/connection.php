...
class connection
{
    public $base_url = 'http://localhost/CopiaCFP1/';
    public $connect;
    public $query;
    public $statement;
    public $cur;
    function connection()
    {
        $this->connect = new PDO("mysql:host=localhost;dbname=proyectocfp", "root", "");
    ...
    {
        $this->query = "
		SELECT cfp_timezone FROM cfp_table 
		LIMIT 1
		";
        $result = $this->get_result();
        foreach ($result as $row) {
            return $row['cfp_timezone'];
        }
    }



    function Get_cfp_logo()
    {
        $this->query = "
		SELECT cfp_logo FROM cfp_table 
		LIMIT 1
		";
        $result = $this->get_result();
        foreach ($result as $row) {
    ...
    {
        $this->query = "
		SELECT cfp_currency FROM cfp_table 
		LIMIT 1
		";
        $result = $this->get_result();

        foreach ($result as $row) {
            $currency = $row['cfp_currency'];
    ...
    {
        $html = '
		<select name="cfp_currency" id="cfp_currency" class="form-control" required>
